...
Original file is located at
    https://colab.research.google.com/drive/1RPquKn3BZwJ2PxwEotL0SscwbeTm4BjC
"""
...
with urlopen('https://partsurfermobile.ext.hpe.com/', data=urlencode({'SelectedCountryID': '', 'SearchString': '817749-B21'}).encode('ascii')) as response:
  page = response.read()
